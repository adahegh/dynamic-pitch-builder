    ...
    <div className="h-screen flex flex-col">
      <div className="max-w-6xl mx-auto w-full flex flex-col h-full">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          ...
          <TabsContent value="pitch-builder" className="flex-1 flex flex-col">
                ...
                <div className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex gap-2">
                      ...
                      />
                      <Button
                        onClick={() => improvePromptWithAI(userInput, 'website', undefined, setUserInput)}
                        disabled={!userInput.trim() || isImprovingPrompt}
                        variant="outline"
                        size="icon"
                    ...
                    {userInput.trim() && promptStrengths['website'] !== undefined && (
                      <div className="flex justify-end">
                        <PromptStrengthIndicator strength={promptStrengths['website']} fieldKey="website" />
                      </div>
                    )}
              ...
              <div className="border-t p-4">
                <div className="space-y-3">
                  <div className="flex gap-2">
                    ...
                    />
                    <Button
                      onClick={() => improvePromptWithAI(feedbackInput, 'feedback', 'Product information feedback', setFeedbackInput)}
                      disabled={!feedbackInput.trim() || isImprovingPrompt}
                      variant="outline"
                      size="icon"
                      title="Improve with AI"
                    >
                  ...
                  {feedbackInput.trim() && promptStrengths['feedback-review'] !== undefined && (
                    <div className="flex justify-end">
                      <PromptStrengthIndicator strength={promptStrengths['feedback-review']} fieldKey="feedback-review" />
                    </div>
                  )}
                </div>
              </div>
            ...
            {step === 'strategy' && (
              <div className="border-t p-4">
                <div className="space-y-3">
                  ...
                  {strategyFeedbackInput.trim() && promptStrengths['feedback-strategy'] !== undefined && (
                    <div className="flex justify-end">
                      <PromptStrengthIndicator strength={promptStrengths['feedback-strategy']} fieldKey="feedback-strategy" />
                    </div>
                  )}
                </div>
              </div>
            ...
            {step === 'objections' && (
              <div className="border-t p-4">
                <div className="space-y-3">
                  ...
                  {objectionsFeedbackInput.trim() && promptStrengths['feedback-objections'] !== undefined && (
                    <div className="flex justify-end">
                      <PromptStrengthIndicator strength={promptStrengths['feedback-objections']} fieldKey="feedback-objections" />
                    </div>
                  )}
                </div>
              </div>
            ...
            {step === 'email-cadence' && (
              <div className="border-t p-4">
                <div className="space-y-3">
                  ...
                  {emailCadenceFeedbackInput.trim() && promptStrengths['feedback-email'] !== undefined && (
                    <div className="flex justify-end">
                      <PromptStrengthIndicator strength={promptStrengths['feedback-email']} fieldKey="feedback-email" />
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {editingPrompts.pitchStrategy.trim() && promptStrengths['system-pitch'] !== undefined && (
                      <PromptStrengthIndicator strength={promptStrengths['system-pitch']} fieldKey="system-pitch" />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {editingPrompts.objectionHandling.trim() && promptStrengths['system-objection'] !== undefined && (
                      <PromptStrengthIndicator strength={promptStrengths['system-objection']} fieldKey="system-objection" />
                    )}
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {editingPrompts.emailCadence.trim() && promptStrengths['system-email'] !== undefined && (
                      <PromptStrengthIndicator strength={promptStrengths['system-email']} fieldKey="system-email" />
                    )}
                  </div>
                </div>
              </div>
