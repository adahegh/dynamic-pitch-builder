...
import { Send, Upload, Globe, FileText, Download, Edit, Check, MessageSquare, ArrowLeft, ArrowRight, Settings, Sparkles } from "lucide-react";
    ...
    <div className="h-screen flex flex-col">
      <div className="max-w-6xl mx-auto w-full flex flex-col h-full">
            ...
            <div className="absolute left-0 top-0 flex items-center gap-2">
              ...
              {['review', 'strategy', 'objections', 'email-cadence'].includes(step) && (
                <Button 
                  variant="outline" 
                  onClick={goNext}
                  className="flex items-center gap-2 text-blue-600 hover:text-blue-800 border-blue-300 hover:bg-blue-50"
                >
                  Next
        ...
        <div className="flex-1 flex gap-6 overflow-hidden">
          {/* Left side - Always present, content varies by step */}
          <div className="w-1/2 flex flex-col">
        <div className="flex-1 flex gap-6 overflow-hidden">
          {/* Left side - Always present, content varies by step */}
          <div className="w-1/2 flex flex-col">
            {/* Product Information (when in review step) */}
            ...
            {step === 'edit' && editingInfo && (
              <div className="bg-blue-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Core Problem Solved:</label>
                    <Textarea
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => setEditingInfo({...editingInfo, keyFeatures: e.target.value.split(',').map(f => f.trim())})}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Success Stories:</label>
                    <Textarea
                      value={editingInfo.successStories}
                      onChange={(e) => setEditingInfo({...editingInfo, successStories: e.target.value})}
                      placeholder="Customer success stories or case studies"
                      rows={3}
                      className="text-base"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Ideal Customer:</label>
                    <Textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Customer Challenges:</label>
                    <Textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Product Solution:</label>
                    <Textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Likely Objections:</label>
                    <Textarea
                      value={editingInfo.objections}
                      onChange={(e) => setEditingInfo({...editingInfo, objections: e.target.value})}
                      placeholder="What objections might prospects have?"
                      rows={3}
                      className="text-base"
                    />
                  </div>
                  ...
                  {editingObjections.map((objection, index) => (
                    <Card key={index} className="p-4 bg-white">
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="block text-sm font-medium mb-1">Proof Point:</label>
                          <Textarea
                            value={objection.proofPoint}
                            onChange={(e) => {
                              const newObjections = [...editingObjections];
                              newObjections[index] = { ...newObjections[index], proofPoint: e.target.value };
                              setEditingObjections(newObjections);
                            }}
                            placeholder="Supporting proof point"
                            rows={2}
                            className="text-base"
                          />
                        </div>
              ...
              <div className="bg-orange-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                ...
                <div className="bg-white rounded-lg border overflow-hidden">
                  <table className="w-full">
                    <thead className="bg-gray-50">
                      <tr>
                        <th className="text-left p-3 font-semibold text-gray-700 border-b w-20">Day</th>
                        <th className="text-left p-3 font-semibold text-gray-700 border-b w-20">Step</th>
                        <th className="text-left p-3 font-semibold text-gray-700 border-b w-48">Type</th>
                        <th className="text-left p-3 font-semibold text-gray-700 border-b">Touchpoint Content / Notes</th>
                      </tr>
                    </thead>
                    <tbody>
                      {emailCadence.map((step, index) => (
                        <tr key={index} className="border-b last:border-b-0">
                          ...
                          <td className="p-3 text-sm text-gray-700 vertical-align-top whitespace-pre-wrap">
                            {step.content}
                          </td>
                        </tr>
                      ))}
                    ...
                    <Card key={index} className="p-4 bg-white">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          placeholder="Email content and notes"
                          rows={4}
                          className="text-base"
                        />
                      </div>
            ...
            {step === 'complete' && productInfo && pitchStrategy && objectionHandling && emailCadence && (
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                <div className="flex justify-between items-center mb-6">
                  <h3 className="font-semibold text-green-800 text-xl">🎉 Pitch Builder Complete!</h3>
                </div>
                
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Card className="p-4 bg-white border-l-4 border-l-purple-500">
                      <h4 className="font-semibold text-purple-800 mb-2">Pitch Strategy</h4>
                      <p className="text-sm text-gray-600">
                        {pitchStrategy.talkTracks.length} talk tracks and {pitchStrategy.talkingPoints.length} key talking points
                      </p>
                    </Card>
                    
                    <Card className="p-4 bg-white border-l-4 border-l-green-500">
                      <h4 className="font-semibold text-green-800 mb-2">Objection Handling</h4>
                      <p className="text-sm text-gray-600">
                        {objectionHandling.length} objection response tactics
                      </p>
                    </Card>
                    
                    <Card className="p-4 bg-white border-l-4 border-l-orange-500">
                      <h4 className="font-semibold text-orange-800 mb-2">Email Cadence</h4>
                      <p className="text-sm text-gray-600">
                        {emailCadence.length}-step email sequence
                      </p>
                    </Card>
                  </div>

                  <div className="bg-white p-4 rounded-lg border">
                    <h4 className="font-semibold text-gray-800 mb-3">Product Overview</h4>
                    <div className="text-sm text-gray-600 space-y-2">
                      <div><strong>Product:</strong> {productInfo.productName}</div>
                      <div><strong>Website:</strong> <span className="text-blue-600">{productInfo.website}</span></div>
                      <div><strong>Core Problem:</strong> {productInfo.coreProblem}</div>
                      <div><strong>Target Customer:</strong> {productInfo.idealCustomer}</div>
                    </div>
                  </div>
                </div>
            ...
            {/* Default state for input step */}
            {step === 'input' && (
              <div className="bg-gray-50 p-6 rounded-lg border flex-1 overflow-y-auto flex items-center justify-center">
                <div className="text-center text-gray-500">
                  <h3 className="text-lg font-semibold mb-2">Ready to Start</h3>
                  <p>Enter your website URL in the chat to begin building your personalized pitch strategy.</p>
                </div>
              </div>
            )}
          </div>
          ...
          <Card className="w-1/2 flex flex-col shadow-lg">
              ...
              <div className="border-t p-4">
                <div className="space-y-3">
                  <div className="flex gap-2">
                    ...
                    />
                    <Button
                      onClick={() => improvePromptWithAI(emailCadenceFeedbackInput, 'feedback', 'Email cadence improvement', setEmailCadenceFeedbackInput)}
                      disabled={!emailCadenceFeedbackInput.trim() || isImprovingPrompt}
                      variant="outline"
                      size="icon"
                      title="Improve with AI"
                    >
