          ...
          {step === 'review' && productInfo && (
            <div className="w-1/2 flex flex-col">
              <div className="bg-blue-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                <h3 className="font-semibold mb-6 text-blue-800 text-xl">Extracted Product & Audience Information</h3>
                    ...
                    <div className="space-y-4">
                      <div className="grid gap-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong className="text-gray-700">Product Website:</strong>
                            <div className="mt-1">
                              <span className="text-blue-600 font-medium">{productInfo.website}</span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="mt-1 text-gray-600">{productInfo.productName || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                            <strong className="text-gray-700">Core Problem:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.coreProblem || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                            <strong className="text-gray-700">Differentiators:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.differentiators || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                            <strong className="text-gray-700">Success Stories:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.successStories || "Not specified"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="grid gap-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong className="text-gray-700">Ideal Customer:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.idealCustomer || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                            <strong className="text-gray-700">Customer Challenges:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.customerChallenges || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          <span className="w-2 h-2 bg-purple-500 rounded-full mt-2 flex-shrink-0"></span>
                          <div>
                            <strong className="text-gray-700">Product Solution:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.productSolution || "Not specified"}</div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            <strong className="text-gray-700">Likely Objections:</strong>
                            <div className="mt-1 text-gray-600">{productInfo.objections || "Not specified"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
