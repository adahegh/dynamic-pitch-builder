            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              {step === 'edit-strategy' && editingStrategy && (
                <div className="flex gap-6 h-full animate-fade-in">
                  {/* Left side - Pitch Strategy Output */}
                  <div className="flex-1 bg-purple-50 p-6 rounded-lg border overflow-y-auto">
                    <h3 className="font-semibold mb-4 text-purple-800 text-lg">Current Pitch Strategy</h3>
                    <div className="space-y-6">
                      {/* Talk Tracks Display */}
                      <div className="bg-white p-4 rounded-lg border">
                        ...
                        <div className="space-y-3">
                          {editingStrategy.talkTracks.map((track, index) => (
                            <div key={index} className="bg-blue-50 p-3 rounded">
                              <p className="font-medium text-blue-800 mb-1">Talk Track {index + 1}:</p>
                              <p className="text-blue-700 text-sm">{track}</p>
                            </div>
                          ))}
                        </div>
                      </div>
                        ...
                        <div className="space-y-2">
                          {editingStrategy.talkingPoints.map((point, index) => (
                            <div key={index} className="flex items-start gap-2">
                              ...
                              <p className="text-purple-700 text-sm">{point}</p>
                            </div>
                          ))}
                        </div>
                      </div>
                  ...
                  <div className="flex-1 bg-white p-6 rounded-lg border overflow-y-auto">
                    <h3 className="font-semibold mb-4 text-gray-800 text-lg">Edit Strategy</h3>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border rounded-lg p-4">
                        ...
                        <div className="space-y-3">
                          {editingStrategy.talkingPoints.map((point, index) => (
                            <div key={index} className="flex items-start gap-2">
                              <span className="text-purple-600 font-bold mt-2 text-lg">•</span>
                              <div className="flex-1">
                                <label className="block text-sm font-medium mb-1">Point {index + 1}:</label>
                                <Textarea
                                  value={point}
                                  onChange={(e) => {
                                  ...
                                  placeholder={`Enter talking point ${index + 1}`}
                                  rows={2}
                                  className="text-sm"
                                />
                              </div>
