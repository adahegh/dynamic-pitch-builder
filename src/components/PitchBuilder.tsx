...
import { Send, Upload, Globe, FileText, Download, Edit, Check, MessageSquare, ArrowLeft, ArrowRight, Settings, Sparkles, ExternalLink, LogOut, User } from "lucide-react";
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
          <TabsList className="grid w-full grid-cols-2 mb-4">
            ...
            <TabsTrigger 
              ...
              disabled={!showSystemPrompts}
              style={{ display: showSystemPrompts ? 'flex' : 'none' }}
            >
