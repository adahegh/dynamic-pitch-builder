              ...
              <div className="border-t bg-background">
                <div className="p-8 space-y-8">
                  ...
                  <div className="text-center space-y-3">
                    <h2 className="text-2xl font-bold text-foreground">Analyze Your Product</h2>
                    <p className="text-muted-foreground text-base max-w-2xl mx-auto">
                      Get started by providing information about your product using any of the methods below. 
                      The more details you provide, the better your personalized pitch strategy will be.
                    </p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <Label className="text-base font-medium text-foreground">Website URL</Label>
                          <p className="text-sm text-muted-foreground">Analyze your product website for key information</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Input
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <Label className="text-base font-medium text-foreground">Product Description</Label>
                          <p className="text-sm text-muted-foreground">Describe your product, its features, and target audience</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Textarea
                          placeholder="Enter a detailed description of your product, including key features, benefits, target audience, and what makes it unique..."
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <Label className="text-base font-medium text-foreground">Upload Document</Label>
                          <p className="text-sm text-muted-foreground">Upload a PDF containing product information or marketing materials</p>
                        </div>
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="pt-4">
                      ...
                      >
                        ...
                        Analyze & Generate Pitch Strategy
                      </Button>
                    </div>
                  </div>
                </div>
