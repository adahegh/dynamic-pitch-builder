...
import { Send, Upload, Globe, FileText, Download, Edit, Check, MessageSquare, ArrowLeft, ArrowRight } from "lucide-react";
...
type Step = 'input' | 'processing' | 'review' | 'edit' | 'generate' | 'strategy' | 'edit-strategy' | 'objections' | 'edit-objections' | 'email-cadence' | 'complete';
    ...
    <div className="h-screen flex flex-col p-4">
      <div className="max-w-6xl mx-auto w-full flex flex-col h-full">
        <div className="text-center mb-6 relative">
          ...
          {['review', 'edit', 'strategy', 'edit-strategy', 'objections', 'edit-objections', 'email-cadence', 'complete'].includes(step) && (
        ...
        <div className="flex-1 flex gap-4 overflow-hidden">
            ...
            <div className="w-1/2 flex flex-col">
              <div className="bg-green-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                ...
                <div className="flex flex-col gap-3 mt-6">
                  ...
                  <Button onClick={generateEmailCadence} className="bg-orange-600 hover:bg-orange-700 w-full">
            ...
            <div className="w-1/2 flex flex-col">
              <div className="bg-orange-50 p-6 rounded-lg border flex-1 overflow-y-auto">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Button onClick={() => setStep('complete')} className="bg-orange-600 hover:bg-orange-700">
                    <Check className="w-4 h-4 mr-2" />
                    Complete
                  </Button>
                </div>
          ...
          <Card className={`${(step === 'review' || step === 'strategy' || step === 'edit-strategy' || step === 'objections' || step === 'edit-objections' || step === 'email-cadence') ? 'w-1/2' : 'w-full'} flex flex-col shadow-lg`}>
