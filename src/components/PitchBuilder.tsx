...
import { Send, Upload, Globe, FileText, Download, Edit, Check, MessageSquare } from "lucide-react";
...
type Step = 'input' | 'processing' | 'review' | 'edit' | 'feedback' | 'generate' | 'complete';
...
export function PitchBuilder() {
  ...
  const handleFeedbackSubmit = async () => {
    if (!userInput.trim() || !productInfo) {
      toast.error("Please enter your feedback.");
      return;
    }

    setIsLoading(true);
    const feedbackMessage = userInput;
    setUserInput('');
    ...
    try {
      ...
      addMessage('bot', "Great! I've updated the information based on your feedback. Please review the changes:");
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto w-full flex flex-col h-full">
        ...
        <Card className="flex-1 flex flex-col shadow-lg">
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {step === 'feedback' && productInfo && (
              <div className="bg-green-50 p-6 rounded-lg border animate-fade-in">
                <h3 className="font-semibold mb-4 text-green-800 text-lg">Provide Feedback via Chat</h3>
                <p className="text-green-700 mb-4">Tell me what changes you'd like to make to the product and audience information. I'll update the details based on your feedback.</p>
                
                <div className="bg-white p-4 rounded-lg border mb-4 max-h-60 overflow-y-auto">
                  <h4 className="font-semibold text-gray-700 mb-2">Current Information Summary:</h4>
