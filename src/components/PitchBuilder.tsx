              ...
              <div className="border-t p-4">
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) => setEmailCadenceFeedbackInput(e.target.value)}
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Textarea
                    ...
                    onChange={(e) => setEditingPrompts({...editingPrompts, pitchStrategy: e.target.value})}
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Textarea
                    ...
                    onChange={(e) => setEditingPrompts({...editingPrompts, objectionHandling: e.target.value})}
              ...
              <div>
                ...
                <div className="space-y-2">
                  <Textarea
                    ...
                    onChange={(e) => setEditingPrompts({...editingPrompts, emailCadence: e.target.value})}
